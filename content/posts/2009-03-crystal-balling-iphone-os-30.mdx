...
Rather than get carried away nitpicking on specific features that will or will not be announced, however, I will instead offer a prediction about what I anticipate to wind up being the common thread to them; their long term purpose.
...
Apart from production planning and resource coordination concerns, it's important to remember that some seemingly formidable competitors to the iPhone are about to hit market.  One that is likely to have Apple genuinely attentive is [Palm's Pre](http://www.palm.com/us/products/phones/pre/).
