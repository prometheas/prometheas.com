...
And although Blogger's functionality is "sufficient," it's just no fun to use. Wordpress, by contrast, is constantly adding polish to the user experience of the CMS.
